...
*/
	...
	{ onRecordingDataAvailable(dev, packet); }
	...
	virtual void onAllBufferedDataAvailable(XsDevicePtrArray* devs, const XsDataPacket** packets)
	{ onAllRecordingDataAvailable(devs, packets); }
	...
	virtual void onAllDataAvailable(XsDevicePtrArray* devs, const XsDataPacket** packets)
	...
	virtual void onAllRecordedDataAvailable(XsDevicePtrArray* devs, const XsDataPacket** packets)
	{ (void) devs; (void) packets; m_onAllRecordedDataAvailable = 0; }

	//deprecated
	/*! \copydoc m_onBufferedDataAvailable
		\deprecated Use onBufferedDataAvailable instead
	*/
	virtual void onRecordingDataAvailable(XsDevice* dev, const XsDataPacket* packet)
	{ (void) dev; (void) packet; m_onBufferedDataAvailable = 0; }
	/*! \copydoc m_onAllBufferedDataAvailable
		\deprecated Use onAllBufferedDataAvailable instead
	*/
...
/*! \privatesection */
	...
	static void sonAllBufferedDataAvailable(XsCallbackPlainC* cb, XsDevicePtrArray* devs, const XsDataPacket** packets) { ((XsCallback*)cb)->onAllBufferedDataAvailable(devs, packets); }
	...
	static void sonAllDataAvailable(XsCallbackPlainC* cb, XsDevicePtrArray* devs, const XsDataPacket** packets) { ((XsCallback*)cb)->onAllDataAvailable(devs, packets); }
	...
	static void sonAllRecordedDataAvailable(XsCallbackPlainC* cb, XsDevicePtrArray* devs, const XsDataPacket** packets) { ((XsCallback*)cb)->onAllRecordedDataAvailable(devs, packets); }
};
#endif
