...
enum XsComCallbackOptions {
		...
		, XSC_RecordingPacket		= XSC_BufferedPacket	//!< \deprecated recording packet callback enable
		, XSC_RecordingPackets		= XSC_BufferedPackets	//!< \deprecated recording packets callback enable

		, XSC_All					= 0x00FF	//!< all calbacks are enabled
};
/*! @} */
