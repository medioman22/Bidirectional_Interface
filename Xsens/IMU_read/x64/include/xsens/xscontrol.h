...
XDA_DLL_API int XsControl_openImarPort_internal_1(struct XsControl* thisPtr, int portNr, XsBaudRate baudrate, int imarType, uint32_t timeout);/*!< \private*/
...
struct XsControl {
	...
	/*! \private*/
	inline bool openImarPort_internal(int portNr, XsBaudRate baudrate, int imarType, uint32_t timeout = 0)
	{
		return 0 != XsControl_openImarPort_internal_1(this, portNr, baudrate, imarType, timeout);
	}
