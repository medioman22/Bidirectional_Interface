	...
	*/
	inline bool operator == (const XsEuler& other) const
	{
        ...
        */
        ...
        /*! \brief Returns difference between Euler Angles
        */
        inline XsEuler operator - (const XsEuler& other) const
        {
                return XsEuler(m_roll - other.m_roll, m_pitch - other.m_pitch, m_yaw - other.m_yaw);
        }
