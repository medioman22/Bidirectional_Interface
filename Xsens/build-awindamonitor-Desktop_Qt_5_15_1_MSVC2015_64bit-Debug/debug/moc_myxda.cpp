...
void MyXda::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyXda::*)(XsPortInfo );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyXda::wirelessMasterDetected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyXda::*)(XsPortInfo );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyXda::dockedMtwDetected)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyXda::*)(XsPortInfo );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyXda::mtwUndocked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MyXda::*)(XsPortInfo );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyXda::openPortSuccessful)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (MyXda::*)(XsPortInfo );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyXda::openPortFailed)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyXda::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MyXda.data,
    qt_meta_data_MyXda,
    qt_static_metacall,
    nullptr,
    nullptr
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyWirelessMasterCallback *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId , XsResultValue );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::deviceError)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::measurementStarted)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::measurementStopped)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::waitingForRecordingStart)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::recordingStarted)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwDisconnected)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwRejected)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwPluggedIn)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwWireless)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwFile)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwUnknown)) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::mtwError)) {
                *result = 11;
                return;
            }
        }
        {
            using _t = void (MyWirelessMasterCallback::*)(XsDeviceId , int , int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWirelessMasterCallback::progressUpdate)) {
                *result = 12;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyWirelessMasterCallback::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MyWirelessMasterCallback.data,
    qt_meta_data_MyWirelessMasterCallback,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyMtwCallback *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyMtwCallback::*)(XsDeviceId , XsDataPacket );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMtwCallback::dataAvailable)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyMtwCallback::*)(XsDeviceId , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMtwCallback::batteryLevelChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyMtwCallback::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MyMtwCallback.data,
    qt_meta_data_MyMtwCallback,
    qt_static_metacall,
    nullptr,
    nullptr
} };
